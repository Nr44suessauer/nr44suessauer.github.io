...
<div style="display: flex; align-items: center; gap: 20px; margin: 20px 0;">
    ...
    <div style="flex: 1;">
        <p style="font-size: var(--article-font-size);">Wednesday was dedicated to travel from Ohrid to Skopje, where we visited the South East European University (SEEU). A journey of 200 kilometers, with 43degree Celsius with a stop at "Sventi Jovan Bigorski".</p>
    </div>
</div>
