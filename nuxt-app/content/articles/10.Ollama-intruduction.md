...
/* ABER: Nicht die Hauptnavigation beeinflussen */
.prose:not(nav):not(header), 
.prose-lg:not(nav):not(header),
.container:not(nav):not(header),
article:not(nav):not(header),
.article-container,
.content-container,
...
/* Stelle sicher, dass die Hauptnavigation nicht betroffen ist */
