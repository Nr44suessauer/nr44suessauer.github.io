...
/* Individuelle Farben für jeden Reiter */
label.ollama-navbar-btn[for="ollama-tab-0"] {
  background: #9c27b0 !important; /* Lila für "How AI Works" */
}
label.ollama-navbar-btn[for="ollama-tab-1"] {
  background: #2196f3 !important; /* Blau für "Preparation" */
}
label.ollama-navbar-btn[for="ollama-tab-2"] {
  background: #ff9800 !important; /* Orange für "Setup for developers" */
}
label.ollama-navbar-btn[for="ollama-tab-3"] {
  background: #4caf50 !important; /* Grün für "A1-Terminal" */
}
label.ollama-navbar-btn[for="ollama-tab-4"] {
  background: #e91e63 !important; /* Pink für "A1-Manual" */
}

/* Dunklere Farben für Hover-Effekt */
label.ollama-navbar-btn[for="ollama-tab-0"]:hover,
#ollama-tab-0:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-0"] {
  background: #7b1fa2 !important;
}
label.ollama-navbar-btn[for="ollama-tab-1"]:hover,
#ollama-tab-1:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-1"] {
  background: #1976d2 !important;
}
label.ollama-navbar-btn[for="ollama-tab-2"]:hover,
#ollama-tab-2:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-2"] {
  background: #f57c00 !important;
}
label.ollama-navbar-btn[for="ollama-tab-3"]:hover,
#ollama-tab-3:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-3"] {
  background: #388e3c !important;
}
label.ollama-navbar-btn[for="ollama-tab-4"]:hover,
#ollama-tab-4:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-4"] {
...
/* Content-Bereich Umrandung basierend auf aktivem Tab */
...
<div class="ollama-navbar">
    <label class="ollama-navbar-btn" for="ollama-tab-0" style="background: #9c27b0;">🧠 How AI Works</label>
    <label class="ollama-navbar-btn" for="ollama-tab-1" style="background: #2196f3;">📋 Preparation</label>
    <label class="ollama-navbar-btn" for="ollama-tab-2" style="background: #ff9800;">⚙️ Setup for developers</label>
    <label class="ollama-navbar-btn" for="ollama-tab-3" style="background: #4caf50;">💬 A1-Terminal</label>
    <label class="ollama-navbar-btn" for="ollama-tab-4" style="background: #e91e63;">📖 A1-Manual</label>
</div>
...
<h4 style="margin-bottom: 16px;">A1-Terminal: H-Term for AI Models</h4>
...
/* Aktive Reiter bekommen ihre dunkleren Farben */
#ollama-tab-0:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-0"] {
  background: #7b1fa2 !important;
...
#ollama-tab-4:checked ~ .ollama-navbar label.ollama-navbar-btn[for="ollama-tab-4"] {
  background: #c2185b !important;
  box-shadow: 0 4px 8px rgba(233, 30, 99, 0.4) !important;
}
#ollama-tab-0:checked ~ .ollama-content-0,
#ollama-tab-1:checked ~ .ollama-content-1,
#ollama-tab-2:checked ~ .ollama-content-2,
